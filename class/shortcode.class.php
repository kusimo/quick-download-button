	...
	public function generate_button() {
		...
		<div class="button--download" style="margin: 6rem auto;width: 200px;">
			<div class="download-button-inner">
				<button class="g-btn f-l position-relative shadow" type="button" title="<?php echo esc_attr( $this->a['title'] ); ?>" 
					<?php
					if ( empty( $this->a['url_external'] ) ) :
						?>
			...
			<?php if ( '0' !== $this->a['extension'] ) : ?>
				<p class="up"><i class="<?php echo esc_attr( $this->qdbu_extension( 'icon' ) ); ?>"></i>
					<?php
